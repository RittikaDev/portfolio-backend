...
// auth(USER_ROLE.admin),
(0, validateRequest_1.default)(projects_validation_1.ProjectValidationSchema.updateProjectValidationSchema), projects_controller_1.ProjectController.updateAProject);
router.delete('/:projectId', (0, validateRequest_1.default)(projects_validation_1.ProjectValidationSchema.updateProjectValidationSchema), projects_controller_1.ProjectController.deleteAProject);
