...
const car_constants_1 = require("../car/car.constants");
...
const getAllUsers = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const carQuery = new QueryBuilder_1.default(user_model_1.User.find({}), query)
        .filter()
        .sort()
        .paginate()
        .fields()
        .search(car_constants_1.searchableUsers);
